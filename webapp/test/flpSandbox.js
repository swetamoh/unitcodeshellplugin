		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Code Shell Plugin",
									"targetURL": "#spfioriunitcodeshellplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"spfioriunitcodeshellplugin-display": {
								"semanticObject": "spfioriunitcodeshellplugin",
								"action": "display",
								"description": "A shell plugin",
								"title": "Unit Code Shell Plugin",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sp.fiori.unitcodeshellplugin",
									"url": sap.ui.require.toUrl("sp/fiori/unitcodeshellplugin")
								}
							}
						}
					}
